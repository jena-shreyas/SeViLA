...
ckpt='lavis/expts/causalvidqa_ft/24_01_2024_10_58_49/checkpoint_best.pth'

CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.run --nproc_per_node=1 --master_port=25778 evaluate.py \
